...
public class HttpsClientRequestFactory extends SimpleClientHttpRequestFactory {
    ...
    private static final String EXPECTED_HTTPSURLCONNECTION_EXCEPTION_STRING =
            "An Instance Of " +
                    "HttpsURLConnection Is " +
                    "Expected !";
    ...
    protected void prepareConnection(HttpURLConnection connection, String httpMethod) {
        try {
            if (!(connection instanceof HttpsURLConnection)) {
                throw new RuntimeException(EXPECTED_HTTPSURLCONNECTION_EXCEPTION_STRING);
            }
    ...
    private static class MyCustomSSLSocketFactory extends SSLSocketFactory {
        ...
        private MyCustomSSLSocketFactory(SSLSocketFactory delegate) {
        ...
        private Socket overrideProtocol(final Socket socket) {
            ...
            ((SSLSocket) socket).setEnabledProtocols(new String[]{TLS_V1});
            return socket;
        }
    }
}