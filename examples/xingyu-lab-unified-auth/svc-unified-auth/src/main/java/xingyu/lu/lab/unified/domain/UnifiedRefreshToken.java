...
public class UnifiedRefreshToken implements Serializable {
    ...
    private Long unified_refresh_token_id;
    ...
    public boolean equals(Object that) {
        ...
        return (this.getUnified_refresh_token_id() == null ? other.getUnified_refresh_token_id() == null : this.getUnified_refresh_token_id().equals(other.getUnified_refresh_token_id()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getUnified_refresh_token_id() == null) ? 0 : getUnified_refresh_token_id().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", unified_refresh_token_id=").append(unified_refresh_token_id);
