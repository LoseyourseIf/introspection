 ...
 **/
@Service
@SofaService(uniqueId = "WaveFlux-Grpc-C", interfaceType = SofaXServiceTriple.IXService.class,
        bindings = {@SofaServiceBinding(
                bindingType = RpcConstants.PROTOCOL_TYPE_TRIPLE,
                serializeType = RpcConstants.SERIALIZE_PROTOBUF)})
public class CootSofaServiceImpl extends SofaXServiceTriple.XServiceImplBase implements BootSofaService {
    @Override
